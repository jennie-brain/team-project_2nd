...
> `가람/0819_고객 여정지도.md` 15절의 12명 대표 Pain Point(각 3개씩)에, **페르소나 전체 Goal** 열과 **Pain Point별 개별 Goal 추론**을 더한 문서입니다. CJM 자체는 건드리지 않고 이 파생 분석만 별도로 둡니다. 06(AOS) 시장기회 분석(`가람/0819_시장기회 분석 방법론(AOS).md`)의 후보 리스트업 입력으로 바로 쓸 수 있습니다.
>
